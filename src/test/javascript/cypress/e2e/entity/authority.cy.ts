...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '3cc322d3-2421-4047-af39-05767ff7920e' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('29d1d411-fac4-4845-a669-2e710aef349b');
      cy.get(`[data-cy="name"]`).should('have.value', '29d1d411-fac4-4845-a669-2e710aef349b');
