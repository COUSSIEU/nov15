...
/**
 * REST controller for managing {@link smallpocs.domain.Materiel}.
 */
@RestController
@RequestMapping("/api/materiels")
public class MaterielResource {

    private static final Logger LOG = LoggerFactory.getLogger(MaterielResource.class);
     ...
     */
    @PostMapping("")
    public ResponseEntity<MaterielDTO> createMateriel(@RequestBody MaterielDTO materielDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/materiels/" + materielDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, materielDTO.getId().toString()))
            .body(materielDTO);
    }
    ...
    public ResponseEntity<MaterielDTO> updateMateriel(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, materielDTO.getId().toString()))
            .body(materielDTO);
    }
    ...
    public ResponseEntity<MaterielDTO> partialUpdateMateriel(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, materielDTO.getId().toString())
        );
    }
